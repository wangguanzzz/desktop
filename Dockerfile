...
RUN cd /opt/ && tar xvf /opt/geckodriver.tar.gz && mv /opt/geckodriver /usr/bin/
ADD https://chromedriver.storage.googleapis.com/2.40/chromedriver_linux64.zip /opt/chromedriver_linux64.zip
